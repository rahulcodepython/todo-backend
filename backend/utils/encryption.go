...
// Encrypt takes a plain-text string (typically a password) and hashes it using the bcrypt algorithm.
...
//
// Parameters:
// - data: The string to be encrypted (e.g., a user's password).
//
// Returns:
...
// CompareEncryptedData compares a plain-text password with a bcrypt-hashed password.
...
//
// Parameters:
// - encryptedData: The bcrypt hash retrieved from storage (e.g., from a database).
